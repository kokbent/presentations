...
- The need for speed, how do we improve?
  - Efficient coding
  - Pre-computing models and results
  
- Continual updating of models and results, for free?
...
- High quality of shape files can take MUCH longer time to render in plots and/or leaflet. Consider "downgrading" it using, [for example](), `gSimplify()` from `rgeos` package.